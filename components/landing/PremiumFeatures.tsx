...
const premiumFeatures = [
  ...
  {
    icon: QrCode,
    title: 'Unique QR Per Attendee',
    description: 'Each attendee gets their own QR code. Fast check-in, professional experience, and detailed analytics.',
    gradient: 'from-orange-500 via-amber-500 to-yellow-500',
    stats: '70% faster check-in',
    color: 'orange',
    pulse: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Smart reminder templates and checklist. Track what you\'ve sent, never miss a follow-up. Manual control, zero risk.',
    gradient: 'from-emerald-500 via-green-500 to-teal-500',
    stats: 'Never miss reminders',
    color: 'emerald',
    pulse: true,
  },
]
